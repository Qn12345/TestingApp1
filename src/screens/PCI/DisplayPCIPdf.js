...
const DisplayPCIPdf = ({route,navigation}) => {
    ...
    const source = { uri: `https://tunasmanja.xbridge.my/index.php/B2b_pci/pci_report?refno=${refNo}`};
...
export default withAuth(DisplayPCIPdf);
