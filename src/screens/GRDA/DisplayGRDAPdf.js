...
const DisplayGRDAPdf = ({route,navigation}) => {
    ...
    const source = { uri: `https://tunasmanja.xbridge.my/index.php/B2b_grda/grda_report?refno=${refNo}`};
...
export default withAuth(DisplayGRDAPdf);
