...
const DisplayPRDNCNPdf = ({route,navigation}) => {
    ...
    const source = { uri: `https://tunasmanja.xbridge.my/index.php/B2b_prdncn/prdncn_report?refno=${refNo}`};
...
export default withAuth(DisplayPRDNCNPdf);
