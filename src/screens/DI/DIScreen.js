...
const DIScreen = ({ navigation }) => {
  ...
  const filteredDIData = DIData.filter((DI) =>
  DI.refno.toLowerCase().includes(searchQuery.toLowerCase())
  );
...
export default withAuth(DIScreen);
